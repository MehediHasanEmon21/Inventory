                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="{{ route('employee.update',$employee->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="experience" name="experience" value="{{ $employee->experience }}" required="">
                                </div>

                                <div class="form-group">
                                    <label for="nid_no">Nid No</label>
                                    <input type="text" class="form-control" id="nid_no" name="nid_no" value="{{ $employee->nid_no }}" required="">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vacation" name="vacation" value="{{ $employee->vacation }}" required="">
                                </div>
                                ...
                                <div class="form-group">
                                    <img src="{{ URL::to($employee->photo) }}" width="80" height="80">
                                </div>
