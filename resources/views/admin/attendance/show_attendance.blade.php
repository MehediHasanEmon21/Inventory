            ...
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <h4 style="text-align: center;color: red;">ALL Attendance {{ $date->att_date }}</h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="radio" name="attendance[{{ $employee->id }}]" disabled="" value="Present" {{ $employee->attendance == 'Present' ? 'checked' : '' }}>Present
                                                <input type="radio" name="attendance[{{ $employee->id }}]" disabled="" value="Absent" {{ $employee->attendance == 'Absent' ? 'checked' : '' }}>Absent
